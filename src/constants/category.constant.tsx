import {ChartNoAxesColumn, CodeXml, DraftingCompass, Footprints, Goal, Lightbulb, List, Rocket} from "lucide-react";
...
export const CLASS_CATEGORY = [
    ...
    {id: 6, label: "마케팅", category: "marketing", icon: <ChartNoAxesColumn/>},
